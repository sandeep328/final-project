...
@Component({
  selector: 'app-dietplanning',
  templateUrl: './dietplanning.component.html',
  styleUrls: ['./dietplanning.component.css']
})
export class DietplanningComponent {
  fontStyle?: string;
  products: any;

  constructor(private ps: HomeService) {
    console.log('Constructor called');
    this.ps.getDairyProducts().subscribe({
      next: (data) => {
        this.products = data;
